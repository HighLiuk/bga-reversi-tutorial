 ...
 * -----
 *
 * highliukreversitutorial.game.php
 *
...
class HighLiukReversiTutorial extends Table
{
    ...
    */
    ...
    /*
        ...
        (note: each method below must match an input method in highliukreversitutorial.action.php)
    */
